                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="post in posts" :key="post.id">
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5">
                                                <inertia-link :href="post.url" class="hover:bg-gray-200 text-gray-500 hover:text-green-500 border border-transparent font-bold py-2 px-4 rounded inline-flex items-center">
